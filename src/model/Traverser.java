...
class Traverser { // half of a visitor
    ...
    public static void main(String[] args) {
        ...
        SgfNode games_=SgfIo.restoreSGF(FileIO.toReader(expectedSgf));
        ...
        games_=SgfIo.restoreSGF(FileIO.toReader(file));
        games=MNode.toGeneralTree(games_);
        traverser.visit(games);
        Logging.mainLogger.info(""+" "+"|||");
        expectedSgf=getSgfData("oneMoveAtA1");
        games_=SgfIo.restoreSGF(FileIO.toReader(expectedSgf));
        games=MNode.toGeneralTree(games_);
        traverser.visit(games);
        Logging.mainLogger.info(""+" "+"|||");
