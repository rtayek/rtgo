...
public class Main extends MainGui {
	...
	Border oppositeBorder(Color color) {
		return BorderFactory.createLineBorder(oppositeColor(color),3);
	}
	void addLabel(JPanel jPanel) { // should be just something to show layout in
									// th panel
	...
	public static void observe(MyJApplet applet,Model model) {
		new Main(applet,model);
	}
	public static void main(String[] args) {
		first.twice(); // do this first in all main programs!
		observe(null,new Model());
	}
	final Model model;
