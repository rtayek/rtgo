...
public class Main extends MainGui implements ActionListener,ComponentListener {
	...
	public static void darken(Container parent) { // over complicated. clean up
													// later.
	...
	public static void main(String[] args) {
		...
		for(Main main:mains) {
			Logging.mainLogger.info(String.valueOf(main.frame.getTitle()));
		}
	...
	@Override public void componentMoved(ComponentEvent e) { //
		...
		if(frame().isVisible()) {
			Point pScteen=frame().getLocationOnScreen();
			Logging.mainLogger.info(p+" "+pScteen);
		}
	}
