...
public class MyTestWatcher extends TestWatcher {
	...
	public MyTestWatcher(Class<? extends Object> klass) {
		this.klass=klass;
		this.verbosity=defaultVerbosity;
	}
	public String ets() {
		return "at: "+first.et+", after: "+et;
	}
	...
	@Override protected void finished(Description description) {
		...
		if(verbosity) Logging.mainLogger
	...
	@Override protected void failed(Throwable e,Description description) {
		if(IOs.currentThreadIsTimeLimited()) Logging.mainLogger.severe("time limited thread!");
		if(verbosity); // Logging.mainLogger.info(reset+description.getMethodName()+"
						// failed!");
