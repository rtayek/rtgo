...
public class SgfNodeTestCase extends AbstractWatchedTestCase {
    ...
    @Test public void testHasAMoveFlag() {
        SgfNode node=SgfTestSupport.nodeWithProperty(P.B,"inside the brackets");
    ...
    @Test public void testHasAMoveTypeFlag() {
        SgfNode node=SgfTestSupport.nodeWithProperty(P.BM,"inside the brackets");
        assertTrue(node.hasAMoveType);
    ...
    @Test public void testBothFlagsFalse() {
        SgfNode node=SgfTestSupport.nodeWithProperty(P.AB,"inside the brackets");
